...
public class BestsellersPage extends Utility {
    ...
    By productNameList=By.xpath("//div[@class='products']//h5");
    By productPriceList=By.xpath("//div[@class='products']//span[@class='price product-price']");
    By productRateList=By.xpath("//div[@class='products']//div[@class='stars-row full']");
    By vinylIdolzAddToCartButton=By.xpath("//button[@class='btn  regular-button add-to-cart product-add2cart productid-13']");
    By productAddedVerifyMessage=By.xpath("//li[contains(text(),'Product has been added to your cart')]");
    By closeButtonForVerifyMessage=By.xpath("//a[@class='close']");
    By yourCartIcon=By.xpath("//div[@title='Your cart']");
    By viewCartButton=By.xpath("//span[contains(text(),'View cart')]");



    public String getPageTitleTextFromBestSellersPage(){
    ...
    public void selectVinylIdolzProductToAddToCart(){
        Reporter.log("Clicking add to cart button of vinylIdilz "+vinylIdolzAddToCartButton.toString()+"<br>");
        mouseHoverAndClickOnElement(vinylIdolzAddToCartButton);
    }

    public String getProductAddedVerifyMessage(){
        Reporter.log("Getting product verify message "+productAddedVerifyMessage.toString()+"<br>");
        return getTextFromElement(productAddedVerifyMessage);
    }

    public void selectCloseButtonForVerifyMessage(){
        Reporter.log("Clicking on verify message close button "+closeButtonForVerifyMessage.toString()+"<br>");
        clickOnElement(closeButtonForVerifyMessage);
    }
